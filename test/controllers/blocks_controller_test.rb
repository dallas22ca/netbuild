...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { details: @block.details, genre: @block.genre, parent: @block.parent, website_id: @block.website_id }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { details: @block.details, genre: @block.genre, parent: @block.parent, website_id: @block.website_id }
    assert_redirected_to block_path(assigns(:block))
  end
