...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { permalink: @website.permalink, theme_id: @website.theme_id, title: @website.title }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { permalink: @website.permalink, theme_id: @website.theme_id, title: @website.title }
    assert_redirected_to website_path(assigns(:website))
  end
