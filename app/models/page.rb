class Page < ActiveRecord::Base
  ...
  before_validation :permalink_is_not_safe, if: Proc.new { |p| %w[websites pages blocks media invoices sign_in sign_out live sitemap search members].include? p.permalink }
