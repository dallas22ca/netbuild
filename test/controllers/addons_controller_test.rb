...
class AddonsControllerTest < ActionController::TestCase
  ...
  test "should create addon" do
    assert_difference('Addon.count') do
      post :create, addon: { available: @addon.available, name: @addon.name, permalink: @addon.permalink, price: @addon.price, quantifiable: @addon.quantifiable }
    end
  ...
  test "should update addon" do
    patch :update, id: @addon, addon: { available: @addon.available, name: @addon.name, permalink: @addon.permalink, price: @addon.price, quantifiable: @addon.quantifiable }
    assert_redirected_to addon_path(assigns(:addon))
  end
