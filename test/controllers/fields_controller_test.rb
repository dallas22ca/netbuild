...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { data_type: @field.data_type, name: @field.name, permalink: @field.permalink }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { data_type: @field.data_type, name: @field.name, permalink: @field.permalink }
    assert_redirected_to field_path(assigns(:field))
  end
